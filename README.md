...
「教材(100本ノック)」モードの100問は、担当教員である marugotoyusuke (Yusuke Kobayashi) 氏の
[基礎プロ100本ノック](https://marugotoyusuke.github.io/Knock100/)を、**作者の許諾を得て原文のまま**収録したものです。
著作権は作者に帰属します。元教材にライセンス表記は無く、この許諾は本リポジトリに対するもので、
第三者への再配布を認めるものではありません。詳細と、フォークする場合の扱いは [NOTICE.md](NOTICE.md) を参照してください。
